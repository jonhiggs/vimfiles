...
hi GitGutterChangeLineDefault         guibg=bg                        ctermfg=3           ctermbg=NONE
hi GitGutterDeleteDefault             guibg=bg                        ctermfg=1            ctermbg=NONE
hi LineNr           guifg=#3D3D3D     guibg=black       gui=NONE      ctermfg=237         ctermbg=NONE        cterm=NONE
hi MatchParen       guifg=#f6f3e8     guibg=#857b6f     gui=BOLD      ctermfg=white       ctermbg=darkgray    cterm=NONE
hi ModeMsg          guifg=black       guibg=#C6C5FE     gui=BOLD      ctermfg=black       ctermbg=cyan        cterm=BOLD
hi NonText          guifg=#3C3C3C     guibg=black       gui=NONE      ctermfg=235         ctermbg=NONE        cterm=NONE
...
hi Search           guifg=NONE        guibg=NONE        gui=NONE      ctermfg=0           ctermbg=11          cterm=NONE
...
hi Title            guifg=#f6f3e8     guibg=NONE        gui=bold      ctermfg=15          ctermbg=NONE        cterm=underline
hi UnwantedTrailerTrash               guibg=red                                           ctermbg=52
hi VertSplit        guifg=#202020     guibg=bg          gui=NONE      ctermfg=darkgray    ctermbg=NONE        cterm=NONE
hi Visual           guifg=NONE        guibg=#4D4C89     gui=NONE      ctermfg=NONE        ctermbg=darkgray    cterm=NONE
